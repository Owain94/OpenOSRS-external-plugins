...
subprojects {
    ...
    dependencies {
        compileOnly(group = "com.openosrs", name = "http-api", version = "3.3.3")
        compileOnly(group = "com.openosrs", name = "runelite-api", version = "3.3.3")
        compileOnly(group = "com.openosrs", name = "runelite-client", version = "3.3.3")
