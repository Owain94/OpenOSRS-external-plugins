...
subprojects {
    ...
    dependencies {
        compileOnly(group = "com.openosrs", name = "http-api", version = "4.20.3")
        compileOnly(group = "com.openosrs", name = "runelite-api", version = "4.20.3")
        compileOnly(group = "com.openosrs", name = "runelite-client", version = "4.20.3")
