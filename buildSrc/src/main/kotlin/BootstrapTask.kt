...
open class BootstrapTask : DefaultTask() {
    ...
    private val EXTERNALS = listOf("chinnmz-plugin", "chincursealch-plugin", "chingiantseaweed-plugin", "chinourania-plugin", "chinbirdhouse-plugin", "chinmta-plugin", "chinmanager-plugin", "chinarceuuslibrary-plugin", "chintellyhoplog-plugin")
